...
<img align="right" src="/img/adapters/prisma.svg" height="64" width="64" className="dark:hidden block" />
  <img align="right" src="/img/adapters/prisma-dark.svg" height="64" width="64" className="dark:block hidden" />
